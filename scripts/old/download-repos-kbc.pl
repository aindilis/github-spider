...
my $gitrepodir = "/var/lib/myfrdcsa/codebases/minor/github-spider/data/searches/kbc/git";

my $i = 0;
foreach my $line (split /\n/, `cat /var/lib/myfrdcsa/codebases/minor/github-spider/data-git/repos-kbc.txt `) {
  ++$i;
